    ...
    scripts: [
        {
            ...
            middle: '中段 3–18s：双人 45° 仰角同步动作 4 拍 → 镜头平移切换 →' +
        ...
        },
        {
            ...
            middle: '中段 4–60s：5 个打卡点剪辑（限定立牌、cos 走秀、谷子摊、痛包 wall、午饭吐槽），' +
                '每点 8–10s + 角标显示打卡时间',
        ...
        },
        {
            ...
            middle: '中段 3–35s：每件谷子单独展示 5s（吧唧、立牌、抱枕、徽章），近景手部 + ' +
        ...
        },
        {
            ...
            middle: '中段 3–55s：分屏左侧线稿、右侧上色，6 倍速过程；穿插 2 段双方语音吐槽 ' +
                '「这里要不要画爆血管」「再加一格」',
        ...
        },
        {
            ...
            middle: '中段 4–55s：5 条贴士各 10s（带什么、穿什么、几点去、怎么吃、怎么聊天），' +
        ...
        },
        {
            ...
            middle: '中段 3–40s：分屏多账号待机 → 0:00 同时点击 → 进度条 → 抢到截图特写 + 庆祝声',
    ...
    captions: [
        {
            ...
            name: '搭子匹配成功 · 默认款',
            body: '今天在次元小镇匹配到了 {partner_name}！我们的共同点是 {common_interest}，' +
                '约好周末一起去 {convention_name}~ 谁懂同好相遇的快乐！🌸',
        },
        {
            template_id: 'caption_cos_collab_002',
            name: 'Cos 双人合拍 · 仪式感款',
            body: '{ip} {cos_character} × {partner_cos_character}，' +
        ...
        },
        {
            ...
            name: '谷子开箱 · 战利品款',
            body: '{convention_name} 三天，{ip} 限定全套，0 漏！' +
    ...
    duets: [
        {
            ...
            name: '镜面对位合拍',
            description: '上下分屏，双方做镜像同步动作（举手 → 转身 → 出招）4 拍即可。' +
                '建议 BGM 选 4 拍鼓点；机位均使用半身近景，景别一致。',
        },
        {
            template_id: 'duet_relay_002',
            name: '接力剪辑合拍',
            description: '上半段我先 cos 一段招式（5s）→ 切到对方接同一招式（5s）→ 最后 5s 双人定格。' +
                '建议各自单机位拍摄，提交后由其中一方剪辑拼接，时长共 15s。',
        },
        {
            template_id: 'duet_dialogue_003',
            name: '台词对手戏合拍',
            description: '复刻原作经典对话片段（≤ 6 句），双方各拍 3 句近景台词，剪辑时按对话顺序交替。' +
                '建议附加日字幕做仪式感。',
        },
        {
            template_id: 'duet_walkthrough_004',
            name: '漫展同框逛摊合拍',
            description: '一人前置镜头自拍走在前面解说，另一人后置镜头跟拍逛摊画面，剪辑分屏左右拼接。' +
                '建议保留现场环境音，仪式感拉满。',
        },
    ],
};
//# sourceMappingURL=publish_templates.js.map