 ...
 */
export declare const NEIGHBOR_TIE_EPSILON = 0.05;
/**
 ...
 */
export declare function resolveMascotFromVector(weights: MascotWeightVector): MascotType;
//# sourceMappingURL=mascot-resolver.d.ts.map